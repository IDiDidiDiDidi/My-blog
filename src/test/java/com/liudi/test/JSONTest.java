...
import com.liudi.excel.EasyExcelController;
...
public class JSONTest {
    ...
    @Test
    public void test1() {
        String path = com.liudi.utils.JSONTest.class.getClassLoader().getResource("1443071.json").getPath();
